...
- Application surfaces: `AppShell`, `AppShellSidebar`, `AppShellHeader`, `AppShellMain`, `AppShellFooter`, `SidebarHeader`, `SidebarContent`, `SidebarFooter`, `SidebarNav`, `SidebarGroup`, `SidebarGroupLabel`, `SidebarLink`, `SidebarButton`, `PageHeader`, `PageHeaderContent`, `PageHeaderTitle`, `PageHeaderDescription`, `PageHeaderActions`, `Stat`, `StatLabel`, `StatValue`, `StatDescription`, `StatTrend`, `DataList`, `DataListItem`, `DataListTerm`, `DataListDescription`, `DataTable`, `TreeView`, `ResizablePanels`, `Table`, `TableHeader`, `TableBody`, `TableFooter`, `TableRow`, `TableHead`, `TableCell`, `TableCaption`, `ScrollArea`, `Carousel`
