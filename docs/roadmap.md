...
- Application surfaces: `DataList`, `DataListItem`, `DataListTerm`, `DataListDescription`, `TreeView`, `Table`, `TableHeader`, `TableBody`, `TableFooter`, `TableRow`, `TableHead`, `TableCell`, `TableCaption`, `ScrollArea`, `Carousel`
...
1. Add advanced application surfaces such as data table and resizable panels.
2. Expand cross-component examples and catalog-level accessibility audits.
