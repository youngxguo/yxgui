...
- Structure: `Theme`, `AppShell`, `AppShellSidebar`, `AppShellHeader`, `AppShellMain`, `AppShellFooter`, `SidebarHeader`, `SidebarContent`, `SidebarFooter`, `SidebarNav`, `SidebarGroup`, `SidebarGroupLabel`, `SidebarLink`, `SidebarButton`, `Container`, `Flex`, `Grid`, `GridItem`, `Card`, `Item`, `ItemGroup`, `ItemMedia`, `ItemContent`, `ItemTitle`, `ItemDescription`, `ItemActions`, `ItemLink`, `ItemButton`, `Stat`, `Carousel`, `DataList`, `DataTable`, `TreeView`, `ResizablePanels`, `Separator`, `AspectRatio`, `ScrollArea`, `Table`
